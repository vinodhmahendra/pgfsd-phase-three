...
import com.simplilearn.workshop.event.CustomerManger;
...
public class CustomerServiceApplication {
	...
	public static void main(String[] args) {
		...
		CustomerManger customerManger = springContainer.getBean("customerManager",CustomerManger.class);
		customerManger.createNewCustomer();
